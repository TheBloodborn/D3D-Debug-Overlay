...
namespace Capture.Hook
{
    ...
    internal class DXHookD3D11: BaseDXHook
    {
        ...
        void EnsureResources(SharpDX.Direct3D11.Device device, Texture2DDescription description, Rectangle captureRegion, bool useSameDeviceForResize = false)
        {
            ...
            else
            {
                ...
                catch
                {
                    ...
                    EnsureResources(device, description, captureRegion, true);
                    return;
                }
