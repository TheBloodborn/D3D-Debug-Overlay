...
namespace D3D_Debug_Overlay
{
    class Memory
    {
        public class ManageMemory
        {
            ...
            /// <summary>
            /// Intialize which application to access the memory of.
            /// </summary>
            public static void Initialize(string ProcessName)
            {
                ...
                {
                    MessageBox.Show("Couldn't find the process. Please start it first!", "Process not found!", MessageBoxButtons.OK);
                    Environment.Exit(1);
                }
            ...
            /// <summary>
            /// Finds the base address of a module. If not a DLL, it defaults to the EXE.
            /// </summary>
            ...
            /// <summary>
            /// Reads memory of a given address, or addressblock and returns in the desired type.
            /// </summary>
            #region ReadMemory
            ...
            /// <summary>
            /// Writes memory the desired type into a given address, or addressblock.
            /// </summary>
            #region WriteMemory
            ...
            /// <summary>
            /// Converts datatypes into byte arrays and opposite.
            /// </summary>
